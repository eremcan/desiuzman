...
$dosya2 = $sorgu['base']."referanslar/".$rand.$_FILES['file']['name'];
...
if (mysql_query("INSERT INTO referanslar (resim,baslik) VALUES ('$dosya2','$baslik') "))
            {
                echo "<center><font color=#000 size=7><span class=style1>Saved</span>.</font></center>";
				?><META HTTP-EQUIV="Refresh" CONTENT="0; URL=./referanslar.php"> <?
                 ...
                 <div class="panel panel-primary">
						...
						<div class="form-group input-group">
										...
										<div class="form-group input-group">
                                         ...
                                         <input name="baslik" type="text" class="form-control"  id="baslik" size="30">
...
<button type="submit" class="btn btn-default">Ekle</button></form>
  ...
  <div class="row">
                  ...
                  <?php  
  $otels=mysql_query("select * from referanslar  order by id DESC");
  $i=1;
