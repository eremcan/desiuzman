...
if (mysql_query("INSERT INTO urunler (baslik,seo,aciklama,resim,fiyat,cat,barkod,anacat) VALUES ('$title','$sef','$aciklama','$dosya2','$fiyat','$cat','$barkod','$anacat') "))
            {
			
                echo "<center><font color=#000 size=7><span class=style1>Eklendi</span>.</font></center>";
				?><META HTTP-EQUIV="Refresh" CONTENT="3; URL=./urunlistesi.php"> <?
                 ...
                 <div class="panel panel-primary">
                        ...
                        <div class="panel-body"><form name="yuklemeformu" method="post" action="?l=save" enctype="multipart/form-data">
										...
										<div class="form-group input-group">
                                            ...
                                            <input type="text" id="urunkodu" required="" name="urunkodu" class="form-control">
                                            
                                        </div>
										
										<div class="form-group input-group">
                                            <span  style="min-width:127px;" class="input-group-addon">Site Fiyatı</span>
                                            <input type="text" id="sfiyat" required="" name="sfiyat" class="form-control">
...
<select id="cat" name="cat" class="form-control">
  ...
  $otels=mysql_query("select * from kategori WHERE cat='0'  order by baslik ASC   ");
  	...
  	while($otell=mysql_fetch_array($otelss)){ echo '<option value="'.$otell['id'].'">----'.$otell['baslik'].'</option>';
										...
										<div class="form-group input-group">
                                            <span  style="min-width:127px;" class="input-group-addon">Açıklama</span>
                                                 <? echo getEditor('con',""); ?>  
