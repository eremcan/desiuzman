                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            YAZILAR <small>Tüm yazılar</small></h1></div>
                </div>
                <!-- /. ROW  -->
                <div class="row">	<? 
					$l = $_GET["l"];
...
$id = $_GET["id"]; 
$sil = mysql_query("Delete From kurumsal where id='$id'");
...
echo "Error.";
	...
	?><META HTTP-EQUIV="Refresh" CONTENT="2; URL=./yazilistesi.php"> <?
}
break;
}
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                              			 <?php  
  $otels=mysql_query("select * from kurumsal order by id DESC   ");
  	while($otel=mysql_fetch_array($otels)){
		...
		?>                                          <tr class="odd gradeX">
                                            ...
                                            <td  width="200px"class="center"><a href="yaziduzenle.php?id=<?=$otel['id']?>"<button class="btn btn-primary"><i class="fa fa-edit "></i> Düzenle</button></a>
